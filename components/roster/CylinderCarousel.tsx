...
export default function CylinderCarousel({ profiles, onProfileClick, currentUserId, isAdminOrOwner, onRefresh }: CylinderCarouselProps) {
  ...
  // Card dimensions — wider & shorter to show full images
  const CARD_W = isMobile ? 130 : 240;
  const CARD_H = isMobile ? 325 : 360;
  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        {/* === DESKTOP: 3D Cylinder === */}
        <div className="hidden md:block relative w-full overflow-hidden select-none h-[550px]">
          {/* Ambient glow */}
